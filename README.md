...
The website is **GitHub Pages**. The Cloudflare Worker is **Ladder import only** (`stashfound-import`). Disconnect any Cloudflare Git project that tries to build this whole repo as a site.
...
Allflame poe.ninja builds and unique icons are fetched during the GitHub Pages workflow and baked into the static site.
